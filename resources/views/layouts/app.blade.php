...
<head>
    ...
    <link href="{{ asset('backend/admin/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('backend/admin/chart.js/Chart.min.js') }}"></script>
